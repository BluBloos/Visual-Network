...
net = network.Network([784,16,16,10], training_data, 3.0, test_data, 10)
...
window = gfx.gfxNetwork(1280, 720, net, nodesColorSpace, weightsColorSpace, ("tiles", inputRect), ("nodes", outputRect), network.sigmoid, caption="Network Visualization")
